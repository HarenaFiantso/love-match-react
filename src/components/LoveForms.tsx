    ...
    <div>
      <form action="" className="flex flex-col bg-white p-5 rounded-2xl shadow-2xl shadow-pink-200">
        ...
        <div className="flex flex-col justify-center items-center gap-5">
          ...
          />
          <img src="/heart.png" alt="Heart image" width={40} />
          ...
          <input
            ...
            className="bg-gray-100 p-4 rounded outline-pink-200"
          />
          <button className="bg-pink-500 text-white rounded-md px-2 py-4">Tester la compatibilité</button>
        </div>
      </form>
    </div>
  );
